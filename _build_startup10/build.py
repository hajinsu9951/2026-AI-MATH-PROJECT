...
for ph, f, m in [
    ...
    ("{{B64_POSTER1}}", "poster_a.jpg", "jpeg"),
    ("{{B64_POSTER2}}", "poster_b.jpg", "jpeg"),
    ("{{B64_POSTER3}}", "poster_d.jpg", "jpeg"),
    ("{{B64_POSTER4}}", "poster_c.jpg", "jpeg"),
    ("{{B64_POSTER5}}", "poster_e.jpg", "jpeg"),
    ("{{B64_POSTER6}}", "poster_h.jpg", "jpeg"),

...
for ph, f, m in [
    ...
    ("{{B64_PH03}}", "ph03.jpg", "jpeg"),
    ("{{B64_PH04}}", "ph04.jpg", "jpeg"),
    ("{{B64_PH05}}", "ph05.jpg", "jpeg"),
    ("{{B64_PH06}}", "ph06.jpg", "jpeg"),
    ("{{B64_PH07}}", "ph07.jpg", "jpeg"),
    ("{{B64_PH08}}", "ph08.jpg", "jpeg"),
    ("{{B64_PH09}}", "ph09.jpg", "jpeg"),
    ("{{B64_PH10}}", "ph10.jpg", "jpeg"),
    ("{{B64_PH11}}", "ph11.jpg", "jpeg"),
    ("{{B64_PH12}}", "ph12.jpg", "jpeg"),
    ("{{B64_PH13}}", "ph13.jpg", "jpeg"),
    ("{{B64_PH14}}", "ph14.jpg", "jpeg"),
    ("{{B64_PH15}}", "ph15.jpg", "jpeg"),
    ("{{B64_PH16}}", "ph16.jpg", "jpeg"),
    ("{{B64_PH17}}", "ph17.jpg", "jpeg"),
    ("{{B64_PH18}}", "ph18.jpg", "jpeg"),
]:
